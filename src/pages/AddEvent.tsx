            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                  ...
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <input
                        ...
                        name="startTime"
                        id="startTime"
                        defaultValue="09:00" // Set your default start time
                      />
                    </div>
                  </div>
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    ...
                    <div className="w-full sm:w-1/2 ">
                      ...
                      <input
                        ...
                        name="endTime"
                        id="endTime"
                        defaultValue="17:00" // Set your default end time
                      />
                    </div>
                  </div>
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  {/* ... (Other fields like approval, capacity, visibility, etc.) */}
